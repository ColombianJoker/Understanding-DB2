...
-- Timestamp: Sat May 14 13:51:29 2022
...
CREATE SEQUENCE "DB2INST "."SAMPSEQUENCE" AS BIGINT
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."CL_SCHED"
------------------------------------------------
 

CREATE TABLE "DB2INST "."CL_SCHED"  (
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."DEPARTMENT"
------------------------------------------------
 

CREATE TABLE "DB2INST "."DEPARTMENT"  (
...
-- DDL Statements for Primary Key on Table "DB2INST "."DEPARTMENT"

ALTER TABLE "DB2INST "."DEPARTMENT" 
	ADD CONSTRAINT "PK_DEPARTMENT" PRIMARY KEY
		("DEPTNO");



-- DDL Statements for Indexes on Table "DB2INST "."DEPARTMENT"

SET NLS_STRING_UNITS = 'SYSTEM';

CREATE INDEX "DB2INST "."XDEPT2" ON "DB2INST "."DEPARTMENT" 
		("MGRNO" ASC)
...
CREATE INDEX "DB2INST "."XDEPT3" ON "DB2INST "."DEPARTMENT" 
		("ADMRDEPT" ASC)
		
		COMPRESS NO 
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
------------------------------------------------
-- DDL Statements for Table "DB2INST "."EMPLOYEE"
------------------------------------------------
 

CREATE TABLE "DB2INST "."EMPLOYEE"  (
...
-- DDL Statements for Primary Key on Table "DB2INST "."EMPLOYEE"

ALTER TABLE "DB2INST "."EMPLOYEE" 
	ADD CONSTRAINT "PK_EMPLOYEE" PRIMARY KEY
		("EMPNO");



-- DDL Statements for Indexes on Table "DB2INST "."EMPLOYEE"

SET NLS_STRING_UNITS = 'SYSTEM';

CREATE INDEX "DB2INST "."XEMP2" ON "DB2INST "."EMPLOYEE" 
		("WORKDEPT" ASC)
		
		COMPRESS NO 
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
------------------------------------------------
-- DDL Statements for Table "DB2INST "."EMP_PHOTO"
------------------------------------------------
 

CREATE TABLE "DB2INST "."EMP_PHOTO"  (
		  "EMPNO" CHAR(6 OCTETS) NOT NULL , 
...
-- DDL Statements for Primary Key on Table "DB2INST "."EMP_PHOTO"

ALTER TABLE "DB2INST "."EMP_PHOTO" 
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."EMP_RESUME"
------------------------------------------------
 

CREATE TABLE "DB2INST "."EMP_RESUME"  (
		  "EMPNO" CHAR(6 OCTETS) NOT NULL , 
...
-- DDL Statements for Primary Key on Table "DB2INST "."EMP_RESUME"

ALTER TABLE "DB2INST "."EMP_RESUME" 
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."PROJECT"
------------------------------------------------
 

CREATE TABLE "DB2INST "."PROJECT"  (
...
-- DDL Statements for Primary Key on Table "DB2INST "."PROJECT"

ALTER TABLE "DB2INST "."PROJECT" 
	ADD CONSTRAINT "PK_PROJECT" PRIMARY KEY
		("PROJNO");



-- DDL Statements for Indexes on Table "DB2INST "."PROJECT"

SET NLS_STRING_UNITS = 'SYSTEM';

CREATE INDEX "DB2INST "."XPROJ2" ON "DB2INST "."PROJECT" 
		("RESPEMP" ASC)
		
		COMPRESS NO 
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
------------------------------------------------
-- DDL Statements for Table "DB2INST "."PROJACT"
------------------------------------------------
 

CREATE TABLE "DB2INST "."PROJACT"  (
		  "PROJNO" CHAR(6 OCTETS) NOT NULL , 
...
-- DDL Statements for Primary Key on Table "DB2INST "."PROJACT"

ALTER TABLE "DB2INST "."PROJACT" 
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."EMPPROJACT"
------------------------------------------------
 

CREATE TABLE "DB2INST "."EMPPROJACT"  (
		  "EMPNO" CHAR(6 OCTETS) NOT NULL , 
		  "PROJNO" CHAR(6 OCTETS) NOT NULL , 
		  "ACTNO" SMALLINT NOT NULL , 
		  "EMPTIME" DECIMAL(5,2) , 
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."ACT"
------------------------------------------------
 

CREATE TABLE "DB2INST "."ACT"  (
		  "ACTNO" SMALLINT NOT NULL , 
...
-- DDL Statements for Primary Key on Table "DB2INST "."ACT"

ALTER TABLE "DB2INST "."ACT" 
	ADD CONSTRAINT "PK_ACT" PRIMARY KEY
		("ACTNO");



-- DDL Statements for Indexes on Table "DB2INST "."ACT"

SET NLS_STRING_UNITS = 'SYSTEM';

CREATE UNIQUE INDEX "DB2INST "."XACT2" ON "DB2INST "."ACT" 
		("ACTNO" ASC,
		 "ACTKWD" ASC)
		...
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
------------------------------------------------
-- DDL Statements for Table "DB2INST "."IN_TRAY"
------------------------------------------------
 

CREATE TABLE "DB2INST "."IN_TRAY"  (
		  "RECEIVED" TIMESTAMP , 
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."ORG"
------------------------------------------------
 

CREATE TABLE "DB2INST "."ORG"  (
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."STAFF"
------------------------------------------------
 

CREATE TABLE "DB2INST "."STAFF"  (
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."SALES"
------------------------------------------------
 

CREATE TABLE "DB2INST "."SALES"  (
		  "SALES_DATE" DATE , 
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."STAFFG"
------------------------------------------------
 

CREATE TABLE "DB2INST "."STAFFG"  (
		  "ID" SMALLINT NOT NULL , 
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."ADEFUSR"
------------------------------------------------
 SET CURRENT SCHEMA = "DB2INST ";
SET CURRENT PATH = "SYSIBM","SYSFUN","SYSPROC","SYSIBMADM","DB2INST";
...
ALTER TABLE "DB2INST "."ADEFUSR" DEACTIVATE ROW ACCESS CONTROL;
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."EMPMDC"
------------------------------------------------
 

CREATE TABLE "DB2INST "."EMPMDC"  (
		  "EMPNO" INTEGER , 
		  "DEPT" INTEGER , 
		  "DIV" INTEGER )   
		 IN "IBMDB2SAMPLEREL"  
...
------------------------------------------------
-- DDL Statements for Table "DB2INST "."PRODUCT"
------------------------------------------------
 

CREATE TABLE "DB2INST "."PRODUCT"  (
...
-- DDL Statements for Primary Key on Table "DB2INST "."PRODUCT"

ALTER TABLE "DB2INST "."PRODUCT" 
	ADD CONSTRAINT "PK_PRODUCT" PRIMARY KEY
		("PID");



-- DDL Statements for Indexes on Table "DB2INST "."PRODUCT"

SET NLS_STRING_UNITS = 'SYSTEM';

CREATE INDEX "DB2INST "."PROD_DETAIL_XMLIDX" ON "DB2INST "."PRODUCT" 
		("DESCRIPTION" ASC)
...
CREATE INDEX "DB2INST "."PROD_NAME_XMLIDX" ON "DB2INST "."PRODUCT" 
		("DESCRIPTION" ASC)
		...
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
------------------------------------------------
-- DDL Statements for Table "DB2INST "."INVENTORY"
------------------------------------------------
 

CREATE TABLE "DB2INST "."INVENTORY"  (
		  "PID" VARCHAR(10 OCTETS) NOT NULL , 
		  "QUANTITY" INTEGER , 
...
-- DDL Statements for Primary Key on Table "DB2INST "."INVENTORY"

ALTER TABLE "DB2INST "."INVENTORY" 
	ADD CONSTRAINT "PK_INVENTORY" PRIMARY KEY
		("PID");


------------------------------------------------
-- DDL Statements for Table "DB2INST "."CUSTOMER"
------------------------------------------------
 

CREATE TABLE "DB2INST "."CUSTOMER"  (
		  "CID" BIGINT NOT NULL , 
		  "INFO" XML , 
		  "HISTORY" XML )   
		 IN "IBMDB2SAMPLEXML"  
...
-- DDL Statements for Primary Key on Table "DB2INST "."CUSTOMER"

ALTER TABLE "DB2INST "."CUSTOMER" 
	ADD CONSTRAINT "PK_CUSTOMER" PRIMARY KEY
		("CID");



-- DDL Statements for Indexes on Table "DB2INST "."CUSTOMER"

SET NLS_STRING_UNITS = 'SYSTEM';

CREATE UNIQUE INDEX "DB2INST "."CUST_CID_XMLIDX" ON "DB2INST "."CUSTOMER" 
		("INFO" ASC)
...
CREATE INDEX "DB2INST "."CUST_NAME_XMLIDX" ON "DB2INST "."CUSTOMER" 
		("INFO" ASC)
...
CREATE INDEX "DB2INST "."CUST_PHONES_XMLIDX" ON "DB2INST "."CUSTOMER" 
		("INFO" ASC)
...
CREATE INDEX "DB2INST "."CUST_PHONET_XMLIDX" ON "DB2INST "."CUSTOMER" 
		("INFO" ASC)
		...
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
------------------------------------------------
-- DDL Statements for Table "DB2INST "."PURCHASEORDER"
------------------------------------------------
 

CREATE TABLE "DB2INST "."PURCHASEORDER"  (
...
-- DDL Statements for Primary Key on Table "DB2INST "."PURCHASEORDER"

ALTER TABLE "DB2INST "."PURCHASEORDER" 
	ADD CONSTRAINT "PK_PURCHASEORDER" PRIMARY KEY
		("POID");



-- DDL Statements for Indexes on Table "DB2INST "."PURCHASEORDER"

SET NLS_STRING_UNITS = 'SYSTEM';

CREATE INDEX "DB2INST "."PO_CID_XMLIDX" ON "DB2INST "."PURCHASEORDER" 
		("PORDER" ASC)
...
CREATE INDEX "DB2INST "."PO_PRODS_XMLIDX" ON "DB2INST "."PURCHASEORDER" 
		("PORDER" ASC)
...
CREATE INDEX "DB2INST "."PO_ZIP_XMLIDX" ON "DB2INST "."PURCHASEORDER" 
		("PORDER" ASC)
		...
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
------------------------------------------------
-- DDL Statements for Table "DB2INST "."CATALOG"
------------------------------------------------
 

CREATE TABLE "DB2INST "."CATALOG"  (
...
-- DDL Statements for Primary Key on Table "DB2INST "."CATALOG"

ALTER TABLE "DB2INST "."CATALOG" 
	ADD CONSTRAINT "PK_CATALOG" PRIMARY KEY
		("NAME");


------------------------------------------------
-- DDL Statements for Table "DB2INST "."SUPPLIERS"
------------------------------------------------
 

CREATE TABLE "DB2INST "."SUPPLIERS"  (
...
-- DDL Statements for Primary Key on Table "DB2INST "."SUPPLIERS"

ALTER TABLE "DB2INST "."SUPPLIERS" 
	ADD CONSTRAINT "PK_PRODUCTSUPPLIER" PRIMARY KEY
		("SID");


------------------------------------------------
-- DDL Statements for Table "DB2INST "."PRODUCTSUPPLIER"
------------------------------------------------
 

CREATE TABLE "DB2INST "."PRODUCTSUPPLIER"  (
		  "PID" VARCHAR(10 OCTETS) NOT NULL , 
		  "SID" VARCHAR(10 OCTETS) NOT NULL )   
		 IN "IBMDB2SAMPLEXML"  
		 ORGANIZE BY ROW; 
...
-- DDL Statements for Primary Key on Table "DB2INST "."PRODUCTSUPPLIER"

ALTER TABLE "DB2INST "."PRODUCTSUPPLIER" 
	ADD CONSTRAINT "PK_PRODUCTSUPPLIER" PRIMARY KEY
		("PID",
		 "SID");


-- DDL Statements for Foreign Keys on Table "DB2INST "."DEPARTMENT"

ALTER TABLE "DB2INST "."DEPARTMENT" 
	ADD CONSTRAINT "RDE" FOREIGN KEY
		("MGRNO")
	REFERENCES "DB2INST "."EMPLOYEE"
		("EMPNO")
	ON DELETE SET NULL
	ON UPDATE NO ACTION
	ENFORCED
...
-- DDL Statements for Foreign Keys on Table "DB2INST "."EMPLOYEE"
...
-- DDL Statements for Check Constraints on Table "DB2INST "."EMPLOYEE"
...
-- DDL Statements for Foreign Keys on Table "DB2INST "."EMP_PHOTO"
...
-- DDL Statements for Foreign Keys on Table "DB2INST "."EMP_RESUME"
...
-- DDL Statements for Foreign Keys on Table "DB2INST "."PROJECT"
...
-- DDL Statements for Foreign Keys on Table "DB2INST "."PROJACT"
...
-- DDL Statements for Foreign Keys on Table "DB2INST "."EMPPROJACT"

ALTER TABLE "DB2INST "."EMPPROJACT" 
	ADD CONSTRAINT "REPAPA" FOREIGN KEY
		("PROJNO",
		 "ACTNO",
		 "EMSTDATE")
	REFERENCES "DB2INST "."PROJACT"
		("PROJNO",
		 "ACTNO",
		 "ACSTDATE")
	ON DELETE RESTRICT
...
-- DDL Statements for Foreign Keys on Table "DB2INST "."ACT"

ALTER TABLE "DB2INST "."ACT" 
	ADD CONSTRAINT "RPAA" FOREIGN KEY
		("ACTNO")
	REFERENCES "DB2INST "."ACT"
		("ACTNO")
	ON DELETE RESTRICT
	ON UPDATE NO ACTION
	ENFORCED
...
-- DDL Statements for Foreign Keys on Table "DB2INST "."PURCHASEORDER"

ALTER TABLE "DB2INST "."PURCHASEORDER" 
	ADD CONSTRAINT "FK_PO_CUST" FOREIGN KEY
		("CUSTID")
	REFERENCES "DB2INST "."CUSTOMER"
		("CID")
	ON DELETE CASCADE
	ON UPDATE NO ACTION
	ENFORCED
...
CREATE ALIAS "DB2INST "."DEPT" FOR TABLE "DB2INST "."DEPARTMENT";

CREATE ALIAS "DB2INST "."EMP" FOR TABLE "DB2INST "."EMPLOYEE";

CREATE ALIAS "DB2INST "."EMPACT" FOR TABLE "DB2INST "."EMPPROJACT";

CREATE ALIAS "DB2INST "."EMP_ACT" FOR TABLE "DB2INST "."EMPPROJACT";

CREATE ALIAS "DB2INST "."PROJ" FOR TABLE "DB2INST "."PROJECT";
